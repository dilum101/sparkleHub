  ...
  return (
    <section id="pricing" className="py-24 bg-white relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle, #1b3a6b 1px, transparent 1px)',
      ...
      >
        {/* Header */}
        <div
          className={`text-center mb-16 transition-all duration-700 ${vis ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
        >
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Every quote is personalised to your property. Starting prices below
            — final price confirmed before we start.
          </p>
        </div>
            ...
            >
              ...
              {p.badge && (
                <div className="absolute top-4 right-4">
                  <span
                    className="flex items-center gap-1 text-xs font-bold px-3 py-1 rounded-full text-white shadow-md"
        ...
        >
          <p className="text-gray-400 text-sm">
            ...
            <button
              onClick={() => ScrollTo('contact')}
              className="text-[#00b5be] font-semibold hover:underline"
            >
