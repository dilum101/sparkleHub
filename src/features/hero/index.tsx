import { ArrowRight, CheckCircle, Clock, Phone, Shield, ThumbsUp } from "lucide-react";
...
export const Hero = ({}: {}) => {
  ...
  const [panel, setPanel] = useState({ service: "", name: "", phone: "", suburb: "" });
  ...
  const trust = [
    ...
    { icon: <Clock className="w-4 h-4" />, text: "Same-Day Bookings Available" },
  ];
  ...
  return (
    <section id="hero" className="relative overflow-hidden" style={{ minHeight: "92vh" }}>
      ...
      <div
        ...
        style={{ backgroundImage: "url('src/assets/heronew.png')", backgroundPosition: "72% 20%" }}
      />
      ...
      <div
        ...
        style={{ background: "linear-gradient(120deg, transparent 40%, rgba(0,181,190,0.08) 100%)" }}
      />
      ...
      {([
        ...
        <div
          ...
          style={{
            ...
            background: "radial-gradient(circle, rgba(0,181,190,0.35), transparent 70%)",
          }}
        />
      ))}
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start w-full">
          ...
          <div className="lg:col-span-3">
            ...
            >
              ...
              and deep cleaning across Melbourne — reliable, affordable and always
              on time.
            </p>
            ...
            >
              <button onClick={() => ScrollTo("contact")} className="btn-primary text-base px-8 py-4 btn-glow">
            ...
            >
              {[
                ...
                <div key={s.l}>
                  <div className="text-3xl md:text-4xl font-extrabold text-[#00b5be]">{s.n}</div>
                  <div className="text-white text-xs font-semibold uppercase tracking-wider mt-0.5 drop-shadow-sm">{s.l}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div
            className={`lg:col-span-2 hidden lg:block transition-all duration-900 ${vis ? "opacity-100 translate-x-0 scale-100" : "opacity-0 translate-x-12 scale-95"}`}
            style={{ transitionDelay: "350ms" }}
          >
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden" style={{ backdropFilter: "blur(8px)" }}>
              {/* Panel header */}
              <div className="bg-[#1b3a6b] px-6 py-5">
                <p className="text-[#00b5be] text-xs font-bold uppercase tracking-widest mb-1">
                  Free Quote — No Obligation
                </p>
                <h3 className="text-white text-xl font-extrabold">Book a Clean Today</h3>
              </div>
              ...
              <div className="px-6 py-6 space-y-4">
                <div>
                  ...
                  <select
                    value={panel.service}
                    onChange={(e) => setPanel((p) => ({ ...p, service: e.target.value }))}
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      type="tel"
                      value={panel.phone}
                      onChange={(e) => setPanel((p) => ({ ...p, phone: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={panel.suburb}
                    onChange={(e) => setPanel((p) => ({ ...p, suburb: e.target.value }))}
              ...
              <div className="px-6 pb-5 flex items-center gap-3 border-t border-gray-100 pt-4">
                ...
                <span className="text-xs text-gray-500 font-medium">
                  <strong className="text-gray-700">100% satisfaction guarantee</strong> — we make it right
                </span>
              </div>

              {/* Checkmarks */}
              <div className="bg-[#f8fafc] px-6 py-4 grid grid-cols-2 gap-2">
                {["No lock-in contracts", "Eco-friendly products", "Police-checked staff", "Bond back guarantee"].map((t) => (
